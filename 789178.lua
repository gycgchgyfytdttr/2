...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://101914314433314"
...
function library.new(library, name, theme)
	...
	Open.Active = true
	Open.Draggable = true
	Open.Image = "rbxassetid://101914314433314"
	...
	function window.Tab(window, name, icon)
		...
		function tab.section(tab, name, TabVal)
			...
			SectionOpen.Image = "http://www.roblox.com/asset/?id=101914314433314"
			SectionOpened.Name = "SectionOpened"
			SectionOpened.Parent = SectionOpen
			SectionOpened.BackgroundTransparency = 1.000
			SectionOpened.BorderSizePixel = 0
			SectionOpened.Size = UDim2.new(0, 26, 0, 26)
			SectionOpened.Image = "http://www.roblox.com/asset/?id=101914314433314"
